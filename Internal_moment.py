...
plt.title('Internal Bending Moment in [Nm] for all loading cases')
...
plt.plot(span, momentmax, color = 'blue',label='n = -1')

plt.plot(span, momentmin, color = 'red', label = 'n = 2.5')
